...
import { Input, Label, Option, ProductAddButton, ProductBottom, ProductButton, ProductForm, ProductFormLeft, ProductFormRight, ProductInfoBottom, ProductInfoImg, ProductInfoItem, ProductInfoKey, ProductInfoTop, ProductInfoValue, ProductName, ProductPageWrapper, ProductTitle, ProductTitleContainer, ProductTop, ProductTopLeft, ProductTopRight, ProductUpload, ProductUploadImg, PublishIcon, Select, UploadInput, UploadLabel } from './style';
                ...
                <ProductForm>
                    ...
                    <ProductFormRight>
                        <ProductUpload>
                            ...
                            <UploadInput type="file" id="file" style={{display:"none"}}/>
                        </ProductUpload>
